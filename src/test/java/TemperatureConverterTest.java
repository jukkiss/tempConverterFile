...
public class TemperatureConverterTest {
    ...
    public void testKelvinToFah() {
        // Simple test for the kelvinToFah method
        assertEquals(32, converter.kelvinToFah(273.15), 0.01); // Freezing point of water
        assertEquals(212, converter.kelvinToFah(373.15), 0.01); // Boiling point of water
        assertEquals(-459.67, converter.kelvinToFah(0), 0.01); // Absolute zero
    }
}
